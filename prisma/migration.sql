...
-- 7. Notification Jobs Durable Outbox
...
create index idx_notification_jobs_order_id on public.notification_jobs(order_id);
create index idx_notification_jobs_round_id on public.notification_jobs(round_id);
create index idx_notification_jobs_product_id on public.notification_jobs(product_id);
create index idx_notification_jobs_status_available_at on public.notification_jobs(status, available_at);
create index idx_notification_jobs_round_status_created_at on public.notification_jobs(round_id, status, created_at desc);
